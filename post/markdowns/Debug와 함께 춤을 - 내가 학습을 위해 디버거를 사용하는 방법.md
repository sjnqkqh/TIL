# Debug와 함께 춤을 - 내가 학습을 위해 디버거를 사용하는 방법
...
StackTrace를 주의깊게 보면서 얻게되는 가장 큰 장점이 여기서 드러납니다. 내가 공부했던 내용이 실제로 어떤 코드로 구현되었는지 확인하고, 최종적으로 **내가 사용하는 모든 것이 마법이 아니었음을 알게되는 과정.** 이 과정을 통해 우리는 간과하고 지내던 많은 요소들이 어떻게 상호작용하고, 동작하며, 어떤 종료 절차를 밟는지 확인 할 수 있습니다.
